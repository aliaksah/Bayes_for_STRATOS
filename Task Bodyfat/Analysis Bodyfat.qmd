...
After this data cleaning, we repeat the IDA with the clean data. Since the missing values are not overlapping, we don't have to pay special attention to their description.
