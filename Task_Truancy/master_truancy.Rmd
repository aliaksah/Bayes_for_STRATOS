...
###### Use marginaleffects to have a high flexiblity to summarize the ###### results
```{r}
plot.cap0 <- plot_predictions(final.fit0, condition = c("NN_SC","bull","ld"))
plot.cap1 <- plot_predictions(final.fit1, condition = c("NN_SC","bull","ld"))

pdf(file.path(PPath,"Results/plot.cap0.pdf"))
plot.cap0
dev.off()

pdf(file.path(PPath,"Results/plot.cap1.pdf"))
plot.cap1
dev.off()
```
...
```{r}
plot.cap0b <- plot_predictions(final.fit0, condition = c("goal","ld","aca"))
plot.cap1b <- plot_predictions(final.fit1, condition = c("goal","ld","aca"))

pdf(file.path(PPath,"Results/plot.cap0b.pdf"))
plot.cap0b
dev.off()

pdf(file.path(PPath,"Results/plot.cap1b.pdf"))
plot.cap1b
dev.off()
```
