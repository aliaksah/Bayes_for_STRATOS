...
This frequentist analysis follows the simplified statistical analysis plan by
Michael Kammer dated 2.6.2025 (see version history). IDA and descriptives are 
presented in an [overview notebook](./analysis_overview-bacteremia.html).

## Histoy

As of May 2025 it was decided to simplify the analysis compared to the first
versions of the SAP, and to remove variable selection from the task. We now
